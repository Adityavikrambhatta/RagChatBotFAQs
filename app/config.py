...
class Settings(BaseSettings):
    ...
    embedding_provider: str = Field(default="openai", alias="RAG_APP_EMBEDDING_PROVIDER")
    embedding_model: str = Field(default="text-embedding-3-small", alias="RAG_APP_EMBEDDING_MODEL")
